...
type Querier interface {
	...
	ListActionsByGroupIDAndState(ctx context.Context, arg ListActionsByGroupIDAndStateParams) ([]Action, error)
	ListActionsByGroupIDStateAndFeatureName(ctx context.Context, arg ListActionsByGroupIDStateAndFeatureNameParams) ([]Action, error)
