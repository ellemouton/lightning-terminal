...
SELECT a.id, a.session_id, a.account_id, a.macaroon_identifier, a.actor_name, a.feature_name, a.action_trigger, a.intent, a.structured_json_data, a.rpc_method, a.rpc_params_json, a.created_at, a.action_state, a.error_reason
FROM actions a
WHERE (a.session_id = $1 OR $1 IS NULL)
  AND (a.account_id = $2 OR $2 IS NULL)
  AND (a.feature_name = $3 OR $3 IS NULL)
