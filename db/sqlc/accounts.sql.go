...
func (q *Queries) AddAccountInvoice(ctx context.Context, arg AddAccountInvoiceParams) error {
	_, err := q.db.ExecContext(ctx, addAccountInvoice, arg.Hash, arg.ID)
	return err
}
...
func (q *Queries) DeleteAccountPayment(ctx context.Context, arg DeleteAccountPaymentParams) error {
	_, err := q.db.ExecContext(ctx, deleteAccountPayment, arg.Hash, arg.ID)
	return err
}
...
func (q *Queries) GetAccountIDByAlias(ctx context.Context, alias []byte) (int64, error) {
...
func (q *Queries) GetAccountPayment(ctx context.Context, arg GetAccountPaymentParams) (AccountPayment, error) {
	row := q.db.QueryRowContext(ctx, getAccountPayment, arg.Hash, arg.ID)
...
func (q *Queries) ListAccountPayments(ctx context.Context, id int64) ([]AccountPayment, error) {
	rows, err := q.db.QueryContext(ctx, listAccountPayments, id)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
