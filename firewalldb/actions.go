...
func WithSessionID(sessionID session.ID) ListActionOption {
	return func(o *listActionOptions) {
		o.sessionID = sessionID
	}
}

func WithGroupID(groupID session.ID) ListActionOption {
	return func(o *listActionOptions) {
		o.groupID = groupID
	}
}

func WithStartTime(startTime time.Time) ListActionOption {
	return func(o *listActionOptions) {
		o.startTime = startTime
	}
}

func WithEndTime(endTime time.Time) ListActionOption {
	return func(o *listActionOptions) {
		o.endTime = endTime
	}
}

func WithFeatureName(featureName string) ListActionOption {
	return func(o *listActionOptions) {
		o.featureName = featureName
	}
}

func WithActorName(actorName string) ListActionOption {
	return func(o *listActionOptions) {
		o.actorName = actorName
	}
}

func WithMethodName(methodName string) ListActionOption {
	return func(o *listActionOptions) {
		o.methodName = methodName
	}
}

func WithState(state ActionState) ListActionOption {
	return func(o *listActionOptions) {
		o.state = state
	}
}
...
type ActionsWriteDB interface {
	...
	SetActionState(ctx context.Context, al ActionLocator, state ActionState,
