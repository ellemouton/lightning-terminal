...
type SQLQueries interface {
	...
	SetSessionRemotePublicKeyByLocalPublicKey(ctx context.Context, arg sqlc.SetSessionRemotePublicKeyByLocalPublicKeyParams) error
...
func (s *SQLStore) UpdateSessionRemotePubKey(ctx context.Context, localPubKey,
	...
	return s.db.ExecTx(ctx, &writeTxOpts, func(db SQLQueries) error {
		return db.SetSessionRemotePublicKeyByLocalPublicKey(
			ctx, sqlc.SetSessionRemotePublicKeyByLocalPublicKeyParams{
...
//
// NOTE: This is part of the Store interface.
func (s *SQLStore) GetSessionByID(ctx context.Context, alias ID) (*Session,
	error) {
